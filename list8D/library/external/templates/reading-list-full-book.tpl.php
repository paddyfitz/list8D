<li class='item clearfix book'>
	...
	<div class="cover">
	  <?php if (!empty($this->child->resource->Amazon_thumbnailUri_medium)): ?>
	  	<img src="<?php echo $this->child->resource->Amazon_thumbnailUri_medium; ?>" title="cover for <?php echo $this->child->resource->title; ?>" class='cover' />
	  <?php else: ?>
