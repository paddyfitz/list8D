...
$language_data = array(
    ...
    'KEYWORDS' => array(
        1 => array(
            ...
            'return','switch','while','function','global','interface',
            'namespace','new','private','protected','public','self','var',
            'class','const','declare','extends',
            'echo','print'
            ),
        2 => array(
    ...
    'STYLES' => array(
        'KEYWORDS' => array(
            ...
            2 => 'color: #0000bb; ',
            3 => 'color: #0000bb;',
            4 => 'color: #0000bb; font-weight: bold;'
            ),
        'COMMENTS' => array(
            1 => 'color: #FF8000; font-style: italic;',
            2 => 'color: #ff8000; font-style: italic;',
            3 => 'color: #ff8000; font-style: italic;',
            4 => 'color: #ff8000; font-style: italic;',
            'MULTI' => 'color: #ff8000; font-style: italic;'
            ),
        'ESCAPE_CHAR' => array(
            0 => 'color: #007700; font-weight: bold;',
            1 => 'color: #007700; font-weight: bold;',
            2 => 'color: #007700; font-weight: bold;',
            3 => 'color: #007700; font-weight: bold;',
            4 => 'color: #007700; font-weight: bold;',
            5 => 'color: #007700; font-weight: bold; font-style: italic;',
            6 => 'color: #007700; font-weight: bold;',
            'HARD' => 'color: #007700; font-weight: bold;'
            ),
        'BRACKETS' => array(
            0 => 'color: #007700;'
            ),
        ...
        'REGEXPS' => array(
            0 => 'color: #0000bb;',
            1 => 'background-color: blue; color: white;'
            ),
        'SCRIPT' => array(
            0 => '',
            1 => '',
