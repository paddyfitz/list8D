...
* @author list8d
*/
class List8D_Model_Resource_PhysicalMedia extends List8D_Model_Resource {

	protected $_typeName = "Physical Media";
	protected $_type = "PhysicalMedia";
	protected $_expanded = "DVD, CD or other physical resource";
