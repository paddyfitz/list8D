<li class='item clearfix book resource'>
	...
	<div class="details">
		<div class="flags clearfix">
			...
			<?php if ($this->item->getDataValue('scan_request') == "scan_requested"): ?>
				<div class="icon scan-request">Scan Requested</div>
			<?php elseif ($this->item->getDataValue('scan_request') == "scan_available"): ?>
				<div class="icon scan-available-moodle">Scan Available in Moodle</div>
			<?php endif; ?>
	  	...
	  	<div class="metadata-links">
	  		...
	  		<?php if (count($links)===1): ?>
				...
				<?php foreach($links as $link): ?>
				  <a href="<?php echo $link['url']; ?>" class="icon icon-tag-label-arrow"><?php echo isset( $preffix ) ? $preffix : ''; ?><?php echo $link['text']; ?></a>
				<?php endforeach; ?>
			</div>
		<?php endif; ?>
	  ...
	  <?php elseif (is_array($this->item->getResource()->getDataValue('url',false)) && count($this->item->getResource()->getDataValue('url',false))) : ?>
	  	<div class="links">
	  		<h6>Links to online resources</h6>
