...
jQuery.iDrag =	{
	...
	destroy : function()
	{
		return this.each(
			...
			{
				if (this.isDraggable) {
					this.dragCfg.dhe.unbind('click', jQuery.iDrag.draginit);
					this.dragCfg = null;
	...
	draginit : function (e)
	{
		...
		jQuery(document)
			...
			.bind('click', jQuery.iDrag.dragstop);
	...
	{				
		jQuery(document)
			...
			.unbind('click', jQuery.iDrag.dragstop);
	...
	build : function(o)
	{
		...
		return this.each(
			function()
			{
				...
				dhe.bind('click', jQuery.iDrag.draginit);
			}
		)
	}
};
