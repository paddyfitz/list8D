...
jQuery.iNestedSortable = {
        ...
        newSerialize: function (s) {
                ...
                var buildHierarchySer = function(context) {
                        ...
                        thisChildren.each( function(i) {
                                ...
                                retVal[i] = {id: serId};
                                var newContext = jQuery(this).find(e.nestedSortCfg.nestingTag + "." + e.nestedSortCfg.nestingTagClass.split(" ").join(".")).get(0);
        ...
        nestItem: function(e, parent) {
                ...
                var parentNesting = jQuery(parent).find(e.nestedSortCfg.nestingTag + "." + e.nestedSortCfg.nestingTagClass.split(" ").join(".")).eq(0);
                        ...
                        this.each(
                                function() {
                                        ...
                                        this.nestedSortCfg = {
                                                ...
                                                applyPadding : conf.applyPadding ? true : false , 
                                        ...
                                        if (this.nestedSortCfg.applyPadding) {
